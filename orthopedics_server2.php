<?php
 ...
 $regist ="INSERT INTO orthopedics_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM orthopedics_patients WHERE firstname='$firstname' AND lastname='$lastname'";
