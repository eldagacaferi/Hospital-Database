<?php
    ...
    $firstname=mysqli_real_escape_string($conn,$_POST['firstname']);
        ...
        // $query = "SELECT * FROM anesthesiology_patients WHERE firstname='$firstName' OR mbiemri='$lastName' OR email='$email' LIMIT 1";
 ...
 $regist ="INSERT INTO anesthesiology_patients (firstname,lastname,allergy,medicines,date,time,gender,Birthday)
                ...
                $rows = "SELECT * FROM anesthesiology_patients WHERE firstname='$firstname' AND lastname='$lastname'";
