<?php
 ...
 $regist ="INSERT INTO pediatrics_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM pediatrics_patients WHERE firstname='$firstname' AND lastname='$lastname'";
