<?php
 ...
 $regist ="INSERT INTO dermatology_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM dermatology_patients WHERE firstname='$firstname' AND lastname='$lastname'";
