<?php
 ...
 $regist ="INSERT INTO neurosurgery_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM neurosurgery_patients WHERE firstname='$firstname' AND lastname='$lastname'";
