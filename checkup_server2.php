<?php
 ...
 $regist ="INSERT INTO checkup_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM checkup_patients WHERE firstname='$firstname' AND lastname='$lastname'";
