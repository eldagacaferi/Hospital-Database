<?php
 ...
 $regist ="INSERT INTO pulmonology_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM pulmonology_patients WHERE firstname='$firstname' AND lastname='$lastname'";
