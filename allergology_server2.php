<?php
 ...
 $regist ="INSERT INTO allergology_patients (firstname,lastname,allergy,medicines,date,time,gender,birthday)
                ...
                $rows = "SELECT * FROM allergology_patients WHERE firstname='$firstname' AND lastname='$lastname'";
